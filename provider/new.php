...
{
 $query = "SELECT * FROM complain WHERE Provider_id = '$_SESSION[provider_id]' && Status = 1  order by id DESC";
...
function make_services($connect)
{
 ...
 while($row = mysqli_fetch_assoc($result))
 {
  ...
  $data_d = checkdata($row["Status"]);
    ...
    <td><a href="Accept.php?id='.$row["id"].'" class="btn">Accept</a> <a href="Reject.php?id='.$row["id"].'" class="btn-rej">Reject</a></td>
  </tr>
  ';
}
 return $output;
...
<body>
  ...
  <div class="container px-5 py-24 mx-auto">
    <div  class="text-center mb-20">
      <h1 class="sm:text-3xl text-2xl font-medium text-center title-font text-gray-900 mb-4">New Services</h1>
    </div>
</div>
</section>
<div >	<table>
