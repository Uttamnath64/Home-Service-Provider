<?php
require 'conn.php';
   $sql = "SELECT * FROM user_data WHERE id='$_GET[id]' order by id DESC";
...
<html>
<head>
	<title>User Profile View | Admin</title>
</head>
<body>
	<?php
  session_start();
  ...
  <div class="container px-5 py-24 mx-auto">
    <div  class="text-center mb-20">
      <h1 class="sm:text-3xl text-2xl font-medium text-center title-font text-gray-900 mb-4">User Profile @<?=$data['Name']?></h1>
    </div>
    <div class="flex flex-wrap lg:w-4/5 sm:mx-auto sm:mb-2 -mx-2">
      ...
      <div class="p-2 sm:w-1/2 w-full">
        <div class="bg-gray-100 rounded flex p-4 h-full items-center">
          ...
          <span class="title-font font-medium">Password - <?=$data['Password']?></span>
        </div>
      </div>
    </div>
    <a href="user_profile.php?id=<?=$_GET['id']?>" style="width: 7%;" class="flex mx-auto mt-16 text-white bg-yellow-500 border-0 py-2 px-8 focus:outline-none hover:bg-yellow-600 rounded text-lg">Ok</a>
  </div>
</section>
<?php
include 'bottom.php';
