...
{
 $query = "SELECT * FROM complain WHERE Provider_id = $_GET[id] order by id DESC";
 $result = mysqli_query($connect, $query);
 return $result;
}
function user_data($connect,$data)
{
 $query = "SELECT Name FROM user_data WHERE iEd = '$data'";
 $result = mysqli_query($connect, $query);
 return $result;
}
...
function make_services($connect)
{
 ...
 while($row = mysqli_fetch_assoc($result))
 {
  ...
  <tr>
    ...
    <td><a href="complain_user_view.php?id='.$row["id"].'" class="btn">View More</a></td>
  </tr>
  ';
}
 return $output;
