  ...
  <div class="container px-5 py-24 mx-auto">
    ...
    <div class="block lg:w-2/3 w-full sm:flex-row flex-col mx-auto px-8 sm:space-x-4 sm:space-y-0 space-y-4 sm:px-0 items-end">
      <div style="width: 44%; margin-right: 28%; margin-left: 28%;" class="relative mb-4">
        ...
        <label for="description" class="leading-7 text-sm text-gray-600">Service Name</label>
        <input type="text" required="" id="description" name="service" class="w-full bg-white rounded border border-gray-300 focus:border-yellow-500 focus:ring-2 focus:ring-yellow-200 h-16 text-base outline-none text-gray-700 py-1 px-3 resize-none leading-6 transition-colors duration-200 ease-in-out"></textarea>
