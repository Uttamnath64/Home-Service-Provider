...
<body style="padding: 0px 100px 0px 100px;">
  ...
  <div class="container mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center">
    <a class="flex title-font font-medium items-center text-gray-900 mb-4 md:mb-0">
      ...
      <span  class="ml-3 text-xl">Home Service Provider</span>
    </a>
    <nav class="md:mr-auto md:ml-4 md:py-1 md:pl-4 md:border-l md:border-gray-400 flex flex-wrap items-center text-base justify-center">
      ...
      <a <?php if ($nav==2) { ?> style="border-bottom: 2px solid #ff9900;" <?php }?>href="service.php" class="mr-5 <?php if ($nav==2) { ?> text-yellow-500 <?php } ?> hover:text-yellow-500">Service</a>
     <?php if (isset($_SESSION["id"])) { ?>
  <a <?php if ($nav==3) { ?> style="border-bottom: 2px solid #ff9900;" <?php } ?>href="History.php" class="mr-5 <?php if ($nav==3) { ?> text-yellow-500 <?php } ?> hover:text-yellow-500">History</a>
  <a <?php if ($nav==4) { ?> style="border-bottom: 2px solid #ff9900;" <?php } ?>href="payment.php" class="mr-5 <?php if ($nav==4) { ?> text-yellow-500 <?php } ?> hover:text-yellow-500">Payment</a>
 <?php } else { ?>
  <a <?php if ($nav==4) { ?> style="border-bottom: 2px solid #ff9900;" <?php } ?>href="help.php"  class="mr-5 <?php if ($nav==4) { ?> text-yellow-500 <?php } ?> hover:text-yellow-500">Help</a>
<?php } ?>
<?php if (isset($_SESSION['id'])) { ?>
