...
if (isset($_POST['submit'])) {
  $sql = "SELECT * FROM user_data  WHERE Mobile_Number = '$_POST[mobile_number]' and Password = '$_POST[password]'";  
  $result = mysqli_query($conn, $sql);    
  $count = mysqli_num_rows($result); 
  if($count == 1)
  {  
    $sql_data = "SELECT * FROM user_data  WHERE Mobile_Number = '$mobilenumber'"; 
    $result = mysqli_query($conn, $sql);
