...
require 'conn.php';
  ...
  if (isset($_GET['book_now'])) {
    $sql="INSERT INTO complain (Name, Mobile_Number, Email, Status, User_id, Provider_id, Address, Discription, Service, Sub_Service, City, Date_Service)
      VALUES ('$name', '$mobile', '$email', 1, '$_SESSION[id]','$_GET[provider_id]','$_GET[address]','$_GET[description]','$_GET[service]','$_GET[sub_service]','$_GET[city]','$_GET[date]')";
      ...
      else
      {
        ...
        echo 'alert("Booking Feld Try Again.")';
        echo '</script>';
      }
  }
?>
...
<section style=" margin-left: 50px; margin-right: 50px;" class="text-gray-600 body-font relative">
  <div class="container px-5 py-5 mx-auto flex sm:flex-nowrap flex-wrap">
    ...
    <div class="lg:w-1/3 md:w-1/2 bg-white flex flex-col md:ml-auto w-full md:py-8 mt-8 md:mt-0">
      <form action="#" method="get" name="verifydata" onSubmit="return verify_data()">
        <input  type="hidden" name="sub_service" value="<?php echo $_GET['sub_service']; ?>">
      ...
      <strong><input type="submit" name="book_now" style="width: 100%;" value="Book Now" class="text-white bg-yellow-500 border-0 py-2 px-6 focus:outline-none hover:bg-yellow-600 rounded text-lg "> </strong>
