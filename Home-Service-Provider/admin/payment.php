...
{
 $query = "SELECT * FROM payment_user order by id DESC";
...
{
 $query = "SELECT Name FROM provider_data ";
 $result = mysqli_query($connect, $query);
 return $result;
}
...
<body>
  ...
  <div class="container px-5 py-24 mx-auto">
    <div  class="text-center mb-20">
      <h1 class="sm:text-3xl text-2xl font-medium text-center title-font text-gray-900 mb-4">Payment</h1>
    </div>
</div>
</section>
<div >  <table>
